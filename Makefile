...
SOURCES       = src/main.cpp \
		...
		src/HDRLoader.cpp \
		src/optixmodel.cpp \
		src/TextureLoader.cpp moc/moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/Helios.out1.0.0/ && $(COPY_FILE) --parents optixSrc/parallelogram.cu optixSrc/path_tracer.cu optixSrc/sphere.cu optixSrc/triangle_mesh.cu obj/Helios.out1.0.0/ && $(COPY_FILE) --parents include/mainwindow.h include/Camera.h include/ShaderUtils.h include/TextureUtils.h include/ShaderProgram.h include/Texture.h include/OpenGLWidget.h include/Shader.h include/ui_mainwindow.h include/helpers.h include/random.h include/path_tracer.h include/pathtracerscene.h include/pinholecamera.h include/HDRLoader.h include/optixmodel.h include/TextureLoader.h obj/Helios.out1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp src/Camera.cpp src/ShaderUtils.cpp src/TextureUtils.cpp src/ShaderProgram.cpp src/Texture.cpp src/OpenGLWidget.cpp src/Shader.cpp src/pathtracerscene.cpp src/pinholecamera.cpp src/HDRLoader.cpp src/optixmodel.cpp src/TextureLoader.cpp obj/Helios.out1.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui obj/Helios.out1.0.0/ && (cd `dirname obj/Helios.out1.0.0` && $(TAR) Helios.out1.0.0.tar Helios.out1.0.0 && $(COMPRESS) Helios.out1.0.0.tar) && $(MOVE) `dirname obj/Helios.out1.0.0`/Helios.out1.0.0.tar.gz . && $(DEL_FILE) -r obj/Helios.out1.0.0
...
obj/TextureLoader.o: src/TextureLoader.cpp /Users/Toby/Qt5.2.1/5.2.1/clang_64/lib/QtGui.framework/Versions/5/Headers/QImage \
		/Users/Toby/Qt5.2.1/5.2.1/clang_64/lib/QtGui.framework/Versions/5/Headers/qimage.h \
