...
public:
    ...
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief set the tranformation of our environement map
    //----------------------------------------------------------------------------------------------------------------------
    void setGlobalTransEnvironment(glm::mat4 _trans);
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief remove a light from our scene
    //----------------------------------------------------------------------------------------------------------------------
    void removeLight(int _id);
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief Sets the translate environment variable;
    //----------------------------------------------------------------------------------------------------------------------
    inline void setTransLateEnvironment(bool _trans){m_translateEnviroment = _trans;}
    //----------------------------------------------------------------------------------------------------------------------
