...
public:
    ...
    //------------------------------------------------------------------------------------------------------------------------------------
    /// @brief returns a queried material from library if it exits
    /// @param _mat - name of material to be queried
    /// @param o_mat - handle of found material
    /// @return true is material is found
    //------------------------------------------------------------------------------------------------------------------------------------
    bool getMatFromLib(std::string _mat, optix::Material &o_mat);
    //------------------------------------------------------------------------------------------------------------------------------------
signals:

public slots:
    //------------------------------------------------------------------------------------------------------------------------------------
    /// @brief applys selected material to current selected in mesh widget
    //------------------------------------------------------------------------------------------------------------------------------------
    void applyMatToSelected();
    //------------------------------------------------------------------------------------------------------------------------------------
